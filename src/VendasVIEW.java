...
public class VendasVIEW extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(546, 485));
        ...
        if (ListaProdutosVendidos.getColumnModel().getColumnCount() > 0) {
            ListaProdutosVendidos.getColumnModel().getColumn(3).setResizable(false);
        }
